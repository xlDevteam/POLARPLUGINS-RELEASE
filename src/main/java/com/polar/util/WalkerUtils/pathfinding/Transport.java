...
import com.polar.util.WalkerUtils.Util;
...
public class Transport {
    ...
    private static void addTransports(Map<WorldPoint, List<Transport>> transports, String path, TransportType transportType) {
        try {
            String s = new String(Util.readAllBytes(Objects.requireNonNull(WalkerEngine.class.getResourceAsStream(path))), StandardCharsets.UTF_8);
